...
attach_fully_connected_impl::attach_fully_connected_impl() {
    ...
    implementation_map<fully_connected>::add(impl_types::ocl,
        ...
        std::make_tuple(data_types::u8, format::b_fs_yx_fsv4),
                                                 ...
                                                 std::make_tuple(data_types::i16, format::b_fs_yx_fsv32),
                                                 std::make_tuple(data_types::u16, format::b_fs_yx_fsv32),
                                                 std::make_tuple(data_types::i16, format::b_fs_yx_fsv4),
                                                 std::make_tuple(data_types::u16, format::b_fs_yx_fsv4),
        std::make_tuple(data_types::f32, format::b_fs_yx_fsv4),
        std::make_tuple(data_types::i8, format::b_fs_yx_fsv16),
        std::make_tuple(data_types::u8, format::b_fs_yx_fsv16),
        std::make_tuple(data_types::i8, format::bs_fs_yx_bsv16_fsv16),
        std::make_tuple(data_types::u8, format::bs_fs_yx_bsv16_fsv16),
                                                 std::make_tuple(data_types::i16, format::b_fs_yx_fsv16),
                                                 std::make_tuple(data_types::u16, format::b_fs_yx_fsv16),
                                                 std::make_tuple(data_types::i16, format::bs_fs_yx_bsv16_fsv16),
                                                 std::make_tuple(data_types::u16, format::bs_fs_yx_bsv16_fsv16),
