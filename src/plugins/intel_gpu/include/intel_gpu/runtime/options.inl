...
OV_CONFIG_RELEASE_OPTION(ov::hint, inference_precision, ov::element::f16, "Model floating-point inference precision. Supported values: { f16, bf16, f32, dynamic }", [](ov::element::Type t) { return t == ov::element::f16 || t == ov::element::bf16 || t == ov::element::f32 || t == ov::element::dynamic; })
